            ...
            <Table className="w-full">
              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-left">Student Email</TableHead>
                </TableRow>
              </TableHeader>
  ...
  {calculateTotalStudentsAndProfit().studentList.map(
    (studentItem, index) => (
      <TableRow key={index}>
        ...
        <TableCell className="text-left">{studentItem.studentName}</TableCell>
        <TableCell className="text-left">{studentItem.studentEmail}</TableCell>
      </TableRow>
    )
  )}
</TableBody>
