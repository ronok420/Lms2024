...
const StudentViewCourseDetailsPage = () => {
  ...
  studentViewCourseDetails !== null
    ...
    : -1;
    // Get all videos with a freePreview flag
const freePreviewVideos = studentViewCourseDetails !== null
    ...
    <div className=" mx-auto p-4">
      ...
      <div className="flex flex-col md:flex-row gap-8 mt-8">
             ...
             {/* <aside className="w-full md:w-[500px]">
                  <Card className="sticky top-4">
                    <CardContent className="p-6">
                      <div className="aspect-video mb-4 rounded-lg flex flex-col gap-4 items-center justify-center">
                     
                        {freePreviewVideos.length > 0 ? (
                          freePreviewVideos.map((video, index) => (
                            <VideoPlayer
                              key={index} // Ensure each component has a unique key
                              url={video.videoUrl}  // Use the video URL
                              width="450px"
                              height="200px"
                            />
                          ))
                        ) : (
                          <p>No free preview videos available.</p>
                        )}
                      </div>
                      <div className="mb-4">
                        <span className="text-3xl font-bold">
